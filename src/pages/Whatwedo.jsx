                            ...
                            >
                                ...
                                <div className="block lg:hidden h-full">
                                    <div className="flex flex-col h-full justify-center items-center max-w-sm mx-auto space-y-6 py-8">
                                        ...
                                        >
                                            <motion.button
                                                className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white px-8 py-3.5 rounded-xl font-bold text-base hover:shadow-xl transition-all duration-300 w-full"
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <h3 className="text-sm font-bold text-white mb-1">Got an Idea?</h3>
                                            ...
                                            >
                                                <div className="text-2xl mb-2">🎯</div>
                                                <h3 className="text-sm font-bold text-white mb-1">Have a Vision?</h3>
                                ...
                                <div className="hidden lg:grid lg:grid-cols-2 gap-12 h-full items-center max-w-7xl mx-auto">
                                    ...
                                    >
                                        ...
                                        <div className="relative mb-8">
                                            ...
                                            {/* Orbiting Elements */}
                                            {[
                                                { icon: "🚀", delay: 0, radius: 90, color: "from-blue-400 to-cyan-400" },
                                                { icon: "💡", delay: 1, radius: 80, color: "from-yellow-400 to-orange-400" },
                                                { icon: "⚡", delay: 2, radius: 100, color: "from-purple-400 to-pink-400" },
                                                { icon: "🎯", delay: 3, radius: 85, color: "from-green-400 to-teal-400" },
                                                { icon: "🔧", delay: 4, radius: 95, color: "from-indigo-400 to-blue-400" }
                                            ].map((item, i) => (
                                                <motion.div
                                                    key={i}
                                ...
                                >
                                    <div className="flex flex-col lg:grid lg:grid-cols-2 gap-4 sm:gap-8 lg:gap-12 items-center h-full">
                                        ...
                                        <motion.div
                                            ...
                                            whileHover={{ scale: windowWidth < 768 ? 1.01 : 1.02, y: windowWidth < 768 ? -5 : -10 }}
                                            transition={{ duration: 0.3 }}
                                        >
                                            <div className="flex flex-row items-center mb-3 sm:mb-6">
                                                <div className={`w-10 h-10 sm:w-16 sm:h-16 rounded-lg sm:rounded-2xl bg-gradient-to-r ${step.color} flex items-center justify-center text-white mr-3 sm:mr-4 shadow-lg flex-shrink-0`}>
                                                    <div className="w-5 h-5 sm:w-8 sm:h-8">
                                                        {step.icon}
                                                    </div>
                                                </div>
                                                <div className="min-w-0 flex-1">
                                                    <span className="text-xs sm:text-sm text-gray-400 font-medium block">Step {step.id}</span>
                                                    <h2 className="text-base sm:text-2xl md:text-3xl font-bold text-white leading-tight">{step.title}</h2>
                                                </div>
                                            </div>
                                        ...
                                        >
                                            ...
                                            <motion.div
                                                ...
                                                animate={windowWidth < 768 ? {} : { rotate: [0, 5, -5, 0] }}
                                                transition={{ duration: 4, repeat: Infinity }}
                                            >
                                            ...
                                            {windowWidth >= 640 && [...Array(3)].map((_, i) => (
                                                <motion.div
                                                    ...
                                                    animate={windowWidth < 768 ? {
                                                        ...
                                                        rotate: 360,
                                                        x: Math.cos((i * 120 * Math.PI) / 180) * getOrbitalRadius(),
                                                        y: Math.sin((i * 120 * Math.PI) / 180) * getOrbitalRadius(),
                                                    }}
                                                    transition={windowWidth < 768 ? {
                                ...
                                >
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 justify-center">
                                        <motion.button
                                            ...
                                            whileHover={{ scale: windowWidth < 768 ? 1.02 : 1.05, y: -3 }}
                                            whileTap={{ scale: 0.95 }}
                                        >
                                        ...
                                        <motion.button
                                            ...
                                            whileHover={{ scale: windowWidth < 768 ? 1.02 : 1.05, y: -2 }}
                                            whileTap={{ scale: 0.95 }}
                                        >
                                            View Our Work
                                        </motion.button>
